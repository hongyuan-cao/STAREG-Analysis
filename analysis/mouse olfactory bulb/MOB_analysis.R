...
genes1.by <- overlap[which(p1.by<=alpha)]
p2.by <- p.adjust(pvals2, method = 'BY')
genes2.by <- overlap[which(p2.by<=alpha)]
...
save(overlap, pvals1, pvals2, genes_rep_bh, genes_rep_maxp, genes_rep_repem, file = "output/MOB_results.RData")