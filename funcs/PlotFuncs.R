##-------------------------------------------------------------------------------------------------------------
## Functions used for the plot of spatial expression patterns, which were obtained from the github reposity at
## https://github.com/xzhoulab/SPARK-Analysis/blob/master/funcs/funcs.R (Sun et al., 2020)
##-------------------------------------------------------------------------------------------------------------
